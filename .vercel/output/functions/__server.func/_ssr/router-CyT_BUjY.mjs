...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CyT_BUjY.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-Dbff5T_f.css";
...
var $$splitComponentImporter = () => import("./routes-CJm7OhHu.mjs");
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "eHUB Challenge — Humana" },
		{
			name: "description",
			content: "A gamified training app for Humana claims processing. Study real claim cards, answer rapid-fire questions, earn XP and badges."
		},
		{
			property: "og:title",
			content: "eHUB Challenge — Humana"
		},
		{
			property: "og:description",
