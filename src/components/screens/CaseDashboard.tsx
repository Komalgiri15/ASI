...
export function CaseDashboard() {
  ...
  useEffect(() => {
    speak("Select a case to start your investigation.");
  }, []);
              ...
              {CASES.map((caseDef, i) => {
                ...
                return (
                  <motion.li
                    ...
                    className="flex items-center justify-between p-4 border rounded-lg bg-gradient-to-r from-[#E9F8F0] to-white shadow-sm"
                  >
                    <div>
