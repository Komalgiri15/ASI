  ...
  return (
    <div className="flex h-full w-full items-center justify-center bg-gradient-to-b from-[#E9F8F0] to-[#eefcf4] px-6 py-8 overflow-y-auto">
      <motion.div
        ...
        className="mx-auto w-full max-w-2xl rounded-3xl bg-white p-8 sm:p-10 shadow-card border border-emerald-100 flex flex-col"
      >
        {/* Back Button */}
        <button
          onClick={() => dispatch({ type: "GOTO", screen: "journey" })}
          className="self-start inline-flex items-center gap-2 text-xs font-bold text-slate-500 hover:text-emerald-700 transition"
        >
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center gap-6 pb-6 border-b border-emerald-100/50">
          <div className="relative shrink-0">
            ...
            <Scout mood="think" size={110} className="relative z-10" />
          </div>

          <div className="flex-1 relative bg-emerald-50/50 border border-emerald-100 rounded-2xl p-4 text-sm text-emerald-950 leading-relaxed">
        ...
        <div className="mt-6 grid grid-cols-2 gap-3 text-left">
          <div className="p-3.5 bg-emerald-50/40 border border-emerald-100 rounded-xl">
            <div className="flex items-center gap-1.5 text-[#25BB64] font-bold text-xs">
              ...
              <span className="text-[10px] uppercase tracking-wider font-semibold">Steps to solve</span>
            </div>
          ...
          <div className="p-3.5 bg-emerald-50/40 border border-emerald-100 rounded-xl">
            <div className="flex items-center gap-1.5 text-[#25BB64] font-bold text-xs">
              ...
              <span className="text-[10px] uppercase tracking-wider font-semibold">Reward Badge</span>
            </div>
